...
plot(df2$DateTime, as.numeric(df2$Global_active_power), type="l", xlab="", ylab="Global Active Power", cex=0.2)

plot(df2$DateTime, as.numeric(df2$Voltage), type="l", xlab="datetime", ylab="Voltage")
...
plot(df2$DateTime, as.numeric(df2$Global_reactive_power), type="l", xlab="datetime", ylab="Global_reactive_power")
